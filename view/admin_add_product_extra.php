            ...
            <div class="container">
                <div class="py-5">
                    <div class="row g-4 align-items-center">
                        <div class="col">
                            <h1 class="h3 m-0">Thêm sản phẩm phụ</h1>
                        </div>
                    ...
                    <div class="sa-entity-layout__body">
                        <div class="sa-entity-layout__main">
                            <div class="card">
                                <div class="card-body p-5">
                                    ...
                                    <div class="mb-4">
                                        <label for="form-product/name" class="form-label">Tên sản phẩm phụ</label><input type="text" class="form-control" id="form-product/name" name="tensp">
                                    </div>
                                    <div class="mb-4">
                        ...
                        <div class="sa-entity-layout__sidebar">
                            ...
                            <div class="card w-100 mt-5">
                                <div class="card-body p-5">
                                    <div class="mb-5">
                                        <h2 class="mb-0 fs-exact-18">Phân loại hình ảnh theo danh mục</h2>
                                    </div>
